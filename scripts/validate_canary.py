...
"""Validate the nilx.one concrete Mind Protocol 1.0.0-rc.1 consumer boundary."""
...
def main() -> int:
    ...
    if errors:
        ...
        return 1
    print("nilx.one is a standalone concrete 1.0.0-rc.1 consumer with unchanged organization Identity/context")
    return 0
